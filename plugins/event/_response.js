...
return mecha.sendMessage(m.chat, {audio: {url: 'https://a.uguu.se/cOHUppFf.mp3'}, mimetype: 'audio/mpeg', ptt: true}, {quoted: m, ephemeralExpiration: m.expiration, messageId: messageId})
//mecha.sendMessage(m.chat, {text: `Halo ${m.pushname} 👋🏻\nAda yang bisa saya bantu?`, mentions: [m.sender]}, {quoted: m, ephemeralExpiration: m.expiration, messageId: messageId});
}
